jQuery.extend({
    ...
    createUploadForm: function(id,fileElementId,data,fileElement)
	{
		...
		//20170428 wufei modified start change to multifiles
		//var fileId = 'jUploadFile' + id;
		//20170428 wufei modified end
...
//		jQuery(oldElement).appendTo(form);
		...
		if(fileElement != null && !$.isArray(fileElement)) {
			fileElement = [fileElement];
		} else if (fileElement == null && !$.isArray(fileElementId)) {
