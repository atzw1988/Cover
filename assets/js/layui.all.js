...
$(top.document.getElementsByClassName("indexRemo")).remove();
! function(e) {
	"use strict";
	var t = document,
		o = {
...
! function(e, t) {
	...
	l.anim = ["layer-anim-00", "layer-anim-01", "layer-anim-02", "layer-anim-03", "layer-anim-04", "layer-anim-05", "layer-anim-06"], s.pt.config = {
		...
		if(!t.id || !i("#" + t.id)[0]) {
			...
			i("#layui-layer-shade" + e.index).unbind("mousewheel.layer").bind("mousewheel.layer", function(eee) {
				eee = eee || window.event;
				if(eee.stopPropagation) { //W3C阻止冒泡方法
					eee.stopPropagation();
				} else {
					eee.cancelBubble = true; //IE阻止冒泡方法
				}
			});
		}
		...
		var t = i("#" + l[0] + e),
			n = t.attr("type"),
			a = "layer-anim-close";
		$(window.parent.document.getElementById("oo_"+e)).remove();
		$(window.parent.document.getElementById("cc_"+e)).remove();
		if(t[0]) {
	...
	r.prompt = function(e, t) {
		...
		i = t, n = i(e), l.html = i("html"), r.open = function(e) {
			var t = new s(e);
			var xxx = $('<div id="oo_'+t.index+'" class="indexRemo" style="position: fixed;top: 0;left:0;z-index: 9999;height: 35px;width:100%;background:rgba(0,0,0,.3);"></div>'+
			'<div id="cc_'+t.index+'" class="indexRemo" style="position: fixed;bottom: 0;left:0;z-index: 9999;height: 55px;width:100%;background:rgba(0,0,0,.3);"></div>');
			$(window.parent.document.body).append(
				xxx
			);
			xxx.unbind("mousewheel.layer").bind("mousewheel.layer", function(e) {
				e = e || window.event;
			...
			$(".layui-layer").unbind("mousewheel.layer").bind("mousewheel.layer", function(e) {
				e = e || window.event;
				if(e.stopPropagation) { //W3C阻止冒泡方法
					e.stopPropagation();
				} else {
